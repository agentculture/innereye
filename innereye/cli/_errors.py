...
Every failure inside innereye raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`innereye.cli._output`,
...
# Exit-code policy. Documented in ``innereye learn`` output.
# 0      = success
